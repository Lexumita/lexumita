...
import { Edit2, Check, X, CheckCircle, AlertCircle, Eye, EyeOff } from 'lucide-react'
        ...
        async function carica() {
            try {
                ...
                const { data: profilo } = await supabase
                    .from('profiles')
                    .select('nome, cognome, email, telefono, specializzazioni, studio, tipo_account, verification_status, piano_id, abbonamento_tipo, abbonamento_scadenza, posti_acquistati, include_banca_dati, include_monetizzazione')
                    .eq('id', user.id)
                    .single()
