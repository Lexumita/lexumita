// src/components/layouts/CommercialistaLayout.jsx
//
// Layout per il ruolo 'commercialista' (port del FiduciarioLayout CH).
// Identico all'AvvocatoLayout salvo la NAV: niente Pratiche (il commercialista
// lavora per mandati — il Banco Lavoro arriva con la Fase 1 del modulo).
...
export default function CommercialistaLayout({ children }) {
